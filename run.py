...
def validate_data(values):
    """
    Inside the try, converts all string variables into integers. 
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure from the stock:
    - positive result indicates waste
    - negative result indicates extra made to meet demand.
    """
